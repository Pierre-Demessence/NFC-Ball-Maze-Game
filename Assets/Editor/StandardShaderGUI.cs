...
namespace UnityEditor
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        bool m_OverrideRenderQueue = false;
        ...
        void BlendModePopup(Material material)
        {
        ...
        public static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode)
        {
            switch (blendMode)
            {
                case BlendMode.Opaque:
                    ...
                    //if(!overrideQueue) material.renderQueue = -1;
                    break;
                case BlendMode.Cutout:
                    ...
                    material.DisableKeyword("_ALPHABLEND_ON");
                    material.DisableKeyword("_ALPHAPREMULTIPLY_ON");
                    //if(!overrideQueue) material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.AlphaTest;
                    break;
                case BlendMode.Fade:
                    ...
                    material.DisableKeyword("_ALPHAPREMULTIPLY_ON");
                    //if(!overrideQueue) material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.Transparent;
                    break;
                case BlendMode.Transparent:
                    material.SetOverrideTag("RenderType", "Transparent");
                    material.SetInt("_SrcBlend", (int)UnityEngine.Rendering.BlendMode.One);
